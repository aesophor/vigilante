...
b2BodyBuilder& b2BodyBuilder::newPolygonFixture(const b2Vec2* vertices, size_t count,
                                                float ppm) {
  b2PolygonShape* shape = new b2PolygonShape();
...
b2BodyBuilder& b2BodyBuilder::newPolylineFixture(const b2Vec2* vertices, size_t count,
                                                 float ppm) {
...
b2BodyBuilder& b2BodyBuilder::newEdgeShapeFixture(const b2Vec2& vertex1, const b2Vec2& vertex2,
                                                  float ppm) {
...
b2BodyBuilder& b2BodyBuilder::newCircleFixture(const b2Vec2& centerPos, int radius,
                                               float ppm) {
