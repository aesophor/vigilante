...
CPP_BASE_FLAGS = [
    ...
    '-I' + proj_root + 'cocos2d/cocos/physics',
    '-I' + proj_root + 'cocos2d/cocos/math',
    '-I' + proj_root + 'cocos2d/cocos/2d',
    '-I' + proj_root + 'cocos2d/cocos/ui',
    '-I' + proj_root + 'cocos2d/cocos/network',
    '-I' + proj_root + 'cocos2d/cocos/audio/include',
    '-I' + proj_root + 'cocos2d/cocos/editor-support',
